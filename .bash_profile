...
if [ -n "$CX_DIR" ]; then
  ...
  # alias cxd="cxb && cx"
  alias cinstall="$CX_DIR/cortex.sh -c=$CX_DIR/dev/config/cortex.sh operator install"
  alias cupdate="$CX_DIR/cortex.sh -c=$CX_DIR/dev/config/cortex.sh operator update"
  alias cuninstall="$CX_DIR/cortex.sh -c=$CX_DIR/dev/config/cortex.sh operator uninstall"
