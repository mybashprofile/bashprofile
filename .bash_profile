...
alias kpwa='kubectl get --all-namespaces pod'
alias kpaw='kubectl get --all-namespaces pod'
alias kjwa='kubectl get --all-namespaces job'
alias kjaw='kubectl get --all-namespaces job'
alias kswa='kubectl get --all-namespaces service'
alias ksaw='kubectl get --all-namespaces service'
alias kdwa='kubectl get --all-namespaces deployment'
alias kdaw='kubectl get --all-namespaces deployment'
alias kmwa='kubectl get --all-namespaces daemonset'
alias kmaw='kubectl get --all-namespaces daemonset'
alias kiwa='kubectl get --all-namespaces ingress'
alias kiaw='kubectl get --all-namespaces ingress'
alias kvwa='kubectl get --all-namespaces virtualservices'
alias kvaw='kubectl get --all-namespaces virtualservices'
