...
if ! command -v cortex > /dev/null; then
  ...
  if [ -n "$CX_DIR" ]; then
    ...
    alias cinstall="$CX_DIR/install/install.sh install"
    alias cupdate="$CX_DIR/install/install.sh update"
    alias cuninstall="$CX_DIR/install/install.sh uninstall"
    ...
    alias kstart="$CX_DIR/dev/k8s.sh kops start && kset && cinstall && ostop"
